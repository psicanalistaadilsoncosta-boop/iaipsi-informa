...
const FEEDS = [
  { url: 'https://ge.globo.com/rss/ge/', category: 'Esportes', color: '#ea580c' },
  { url: 'https://g1.globo.com/rss/g1/politica/', category: 'Política', color: '#1e3a8a' },
  { url: 'https://g1.globo.com/rss/g1/economia/', category: 'Economia', color: '#047857' },
  { url: 'https://news.google.com/rss/search?q=saude+mental&hl=pt-BR&gl=BR&ceid=BR:pt-419', category: 'Saúde Mental', color: '#7c3aed' },
  { url: 'https://g1.globo.com/rss/g1/ciencia-e-saude/', category: 'Saúde & Ciência', color: '#0284c7' },
];
...
export default async function Home() {
  ...
  return (
    <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '30px 20px', fontFamily: 'system-ui, -apple-system, sans-serif', backgroundColor: '#f3f4f6', minHeight: '100vh' }}>
      ...
      {/* Grid de Cards Uniformes (Elimina lacunas e desalinhamentos) */}
      <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '20px', alignItems: 'stretch' }}>
        {posts.length === 0 ? (
          ...
          posts.map((item, index) => (
            <article key={index} style={{ backgroundColor: '#ffffff', borderRadius: '12px', overflow: 'hidden', border: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column', boxShadow: '0 2px 4px rgba(0,0,0,0.02)' }}>
              ...
              <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                ...
                {/* Título com altura fixa controlada para manter alinhamento */}
                ...
                {/* Resumo com tamanho restrito */}
                {item.contentSnippet && (
                  <p style={{ color: '#4b5563', margin: '0 0 16px 0', fontSize: '0.875rem', lineHeight: '1.5', height: '3.6em', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                    {item.contentSnippet}
                  </p>
                )}
